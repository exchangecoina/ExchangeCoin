...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "exchangecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"exchangecointools.com", "104.131.81.244"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"exchangecointools.com", "testnet-seed.exchangecointools.com"},
    {"xurious.com", "testnet-seed.exca.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. exchangecoin is probably already running."), addrBind.ToString().c_str());
        else
